...
You cannot gain anymore Cherry Pins {CHERRY_PIN} and you have exactly one week to use it all up until they will disappear on <t:1767502800:f>. I will not be here a lot than usual and I've made my mind to stay and not leave the server or the clan. I will still conduct weekly hunts for you **and** if my life permits me, I can still do events like these every 3 months (March, June, September, December).
...
async def scheduled_petal_lace_shop_clear(
    ...
    desc = f"The shop along with any unused Cherry Pins {CHERRY_PIN} have been removed. Thank you so much for your patron!"
    embed = discord.Embed(
        description=desc,
        color=COLOR,
        timestamp=datetime.now(),
